...
import { readList, loadJson, saveJson } from './io-misc.js';
import { WordsHandler } from './words.js';

const __dirname = path.dirname(fileURLToPath(import.meta.url)),

    ETALON = path.join(__dirname,'../public/static/10000.txt'),
    STAT_DB = path.join(process.env.PWD, 'public/static/list.json'),
    CACHE_DIR = '.cache';
